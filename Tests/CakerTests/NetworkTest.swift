...
final class NetworkConfigTests: XCTestCase {
	...
	func testValidNetwork() throws {
		let vz = VZSharedNetwork(mode: .shared, netmask: "255.255.255.0", dhcpStart: "10.1.0.1", dhcpEnd: "10.1.0.254", uuid: nil, nat66Prefix: nil)

		XCTAssertNoThrow(try vz.validate())
	}

	func testInvalidNetmask() throws {
		let vz = VZSharedNetwork(mode: .shared, netmask: "ABC.255.255.0", dhcpStart: "10.0.0.1", dhcpEnd: "10.0.0.254", uuid: nil, nat66Prefix: nil)
	...
	func testInvalidGateway() throws {
		let vz = VZSharedNetwork(mode: .shared, netmask: "255.255.255.0", dhcpStart: "10.0.0", dhcpEnd: "10.0.0.254", uuid: nil, nat66Prefix: nil)
	...
	func testInvalidDhcpEnd() throws {
		let vz = VZSharedNetwork(mode: .shared, netmask: "255.255.255.0", dhcpStart: "10.0.0.1", dhcpEnd: "192.168.2", uuid: nil, nat66Prefix: nil)
	...
	func testDhcpEndNotInRangeNetwork() throws {
		let vz = VZSharedNetwork(mode: .shared, netmask: "255.255.255.0", dhcpStart: "10.0.0.1", dhcpEnd: "192.168.2.254", uuid: nil, nat66Prefix: nil)
	...
	func testOverlappedNetwork() throws {
		...
		let vz = VZSharedNetwork(macAddress: macAddress, netmask: "\(firstInf.bits)".cidrToNetmask(), dhcpStart: gateway, dhcpEnd: dhcpEnd, uuid: nil, nat66Prefix: nil)
