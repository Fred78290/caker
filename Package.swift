...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/Fred78290/cakeagent.git", revision: "515b2f06fe60b81825a137a9d37b899e48ebd377"),
		...
		.package(url: "https://github.com/Fred78290/swift-nio-portforwarding.git", revision: "d694f2962c563b6866f4f68927c05f18438e16ee"),
	...
	targets: [
		...
		resources: [
			...
			.copy("PackerLite/Resources/redhat.packerlite.yaml"),
			.copy("PackerLite/Resources/macos15.packerlite.yaml"),
			.copy("PackerLite/Resources/macos14.packerlite.yaml"),
			.copy("PackerLite/Resources/alpine.packerlite.yaml"),
			.copy("PackerLite/Resources/centos.packerlite.yaml"),
			.copy("PackerLite/Resources/debian.packerlite.yaml"),
			.copy("PackerLite/Resources/opensuse.packerlite.yaml"),
			.copy("PackerLite/Resources/macos26.packerlite.yaml"),
			.copy("PackerLite/Resources/ubuntu.packerlite.yaml"),
			.copy("PackerLite/Resources/fedora-server.packerlite.yaml"),
			.copy("PackerLite/Resources/fedora.packerlite.yaml"),
			.copy("PackerLite/Resources/macos12.packerlite.yaml"),
		]),
