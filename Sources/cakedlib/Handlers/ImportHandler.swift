...
public struct ImportHandler {
	...
	public static func importVM(importer: Importer, name: String, source: String, userName: String, password: String, clearPassword: Bool, sshPrivateKey: String?, passphrase: String?, uid: UInt32, gid: UInt32, runMode: Utils.RunMode) -> ImportedReply {
