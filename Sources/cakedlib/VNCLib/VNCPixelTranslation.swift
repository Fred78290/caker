...
private func rfbTranslateWithSingleTable<IN: FixedWidthInteger, OUT: FixedWidthInteger>(
	_ lookupTable: [[any FixedWidthInteger]], _ pixelFormat: VNCPixelFormat, _ imageSource: Data, _ bytesPerRow: Int, _ width: Int, _ height: Int, as inputType: IN.Type, to outputType: OUT.Type
) -> Data {
...
private func rfbTranslateWithRGBTable<IN: FixedWidthInteger, OUT: FixedWidthInteger>(
	_ lookupTable: [[any FixedWidthInteger]], _ pixelFormat: VNCPixelFormat, _ imageSource: Data, _ bytesPerRow: Int, _ width: Int, _ height: Int, as inputType: IN.Type, to outputType: OUT.Type
) -> Data {
	var pixelData = Data(count: width * height * MemoryLayout<OUT>.size)
