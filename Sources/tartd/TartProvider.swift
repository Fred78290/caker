...
class TartDaemonProvider: @unchecked Sendable, Tartd_ServiceAsyncProvider {
	...
	func tart(request: Tartd_TartRequest, context: GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
	...
	func clone(request: Tartd_CloneRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func create(request: Tartd_CreateRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func delete(request: Tartd_DeleteRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func fQN(request: Tartd_FqnRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func get(request: Tartd_GetRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func exportVM(request: Tartd_ExportRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func importVM(request: Tartd_ImportRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func iP(request: Tartd_IPRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}
	...
	func list(request: Tartd_ListRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func login(request: Tartd_LoginRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func logout(request: Tartd_LogoutRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}
	...
	func pull(request: Tartd_PullRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func push(request: Tartd_PushRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func rename(request: Tartd_RenameRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func runVM(request: Tartd_RunRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		throw Unimplemented("run is not implemented")
	}

	func set(request: Tartd_SetRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}
	...
	func stop(request: Tartd_StopRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}

	func suspend(request: Tartd_SuspendRequest, context: GRPC.GRPCAsyncServerCallContext) async throws
		-> Tartd_TartReply
	{
		return try await self.execute(command: request)
	}
