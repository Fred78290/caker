...
struct ServiceListView: View {
    ...
    @State private var serviceType: String = "_caked._tcp."
    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                GroupBox("Configuration") {
                    VStack(spacing: 10) {
                        HStack {
                            ...
                            TextField("_caked._tcp.", text: $serviceType)
                ...
                HStack {
                    Button(action: {
                        viewModel.startScanning(serviceType: serviceType, domain: domain)
                    }) {
                        Label("Start lookup", systemImage: "magnifyingglass")
                    }
        ...
        .navigationTitle("Services Bonjour")
        .onDisappear {
            viewModel.stopScanning()
        }
    }
