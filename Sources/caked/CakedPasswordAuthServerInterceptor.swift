...
struct CakedPasswordAuthServerInterceptor: Caked_ServiceServerInterceptorFactoryProtocol {
	...
	func makeVncTunnelInterceptors() -> [ServerInterceptor<Caked_VncStream, Caked_VncStream>] {
		return self.interceptors()
	}
	...
	func makeCertificateInterceptors() -> [ServerInterceptor<Caked_Caked.CertificateRequest, Caked_Reply>] {
		return self.interceptors()
	}

	func makeStopServiceInterceptors() -> [ServerInterceptor<Caked_Empty, Caked_Reply>] {
		return self.interceptors()
	}
}
