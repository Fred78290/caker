...
struct Networks: ParsableCommand {
	...
	struct Create: GrpcParsableCommand {
		static var configuration: CommandConfiguration = CommandConfiguration(abstract: "Create named shared network")
		...
		@Option(name: [.customLong("dhcp-start")], help: ArgumentHelp("IP gateway\n", discussion: "first ip used for the configured shared network, e.g., \"192.168.105.1\""))
	...
	struct Configure: GrpcParsableCommand {
		static var configuration: CommandConfiguration = CommandConfiguration(abstract: "Configure named shared network")
	...
	struct Delete: GrpcParsableCommand {
		static var configuration: CommandConfiguration = CommandConfiguration(abstract: "Delete named shared network")
	...
	struct Start: GrpcParsableCommand {
		static var configuration: CommandConfiguration = CommandConfiguration(abstract: "Start named shared network")
