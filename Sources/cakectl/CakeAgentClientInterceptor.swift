...
final class CakeServiceClientInterceptorFactory: Caked_ServiceClientInterceptorFactoryProtocol {
	...
	func makeCertificateInterceptors() -> [ClientInterceptor<Caked_CertificateRequest,Caked_Reply>] {
		self.interceptors()
	}
	...
	func makeComposeInterceptors() -> [ClientInterceptor<Caked_ComposeRequest, Caked_Reply>] {
		self.interceptors()
	}
