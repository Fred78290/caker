//
// Private function declarations for AMRestorableDevice* (AppleMobileDeviceRestore).
// Ported from VirtualBuddy 2.2-b2 / UTM. See MobileDeviceEnums.h for context.

#pragma once

#import <Foundation/Foundation.h>
#import "MobileDeviceEnums.h"
