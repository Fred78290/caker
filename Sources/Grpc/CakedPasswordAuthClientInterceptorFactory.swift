...
public final class CakedPasswordAuthClientInterceptorFactory: Caked_ServiceClientInterceptorFactoryProtocol {
	...
	public func makeCertificateInterceptors() -> [ClientInterceptor<Caked_Caked.CertificateRequest, Caked_Reply>] {
		self.interceptors(self.chainedInterceptors?.makeCertificateInterceptors())
	}
	
	public func makeStopServiceInterceptors() -> [ClientInterceptor<Caked_Empty, Caked_Reply>] {
		self.interceptors(self.chainedInterceptors?.makeStopServiceInterceptors())
	}
	
	public func makeComposeInterceptors() -> [ClientInterceptor<Caked_ComposeRequest, Caked_Reply>] {
