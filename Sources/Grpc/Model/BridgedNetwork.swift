...
public struct BridgedNetwork: Codable, Hashable, Identifiable, Comparable {
	...
	public var gateway: String = String.empty
	public var dhcpEnd = String.empty
	public var dhcpLease: String = String.empty
