...
public struct DuplicateOptions: ParsableArguments {
	...
	@Flag(help: ArgumentHelp(String(localized: "Duplicate vm in foreground"), discussion: String(localized: "This option allows display window of running vm to debug it"), visibility: .hidden))
