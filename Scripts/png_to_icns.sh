...
mv $output_iconset_name "AppIcon.appiconset"

output_iconset_name="AppIcon.appiconset"
cat > "$output_iconset_name/Contents.json" << EOF
{
  "images" : [
    {
      "size" : "16x16",
...
mv "AppIcon.appiconset" "Assets.xcassets/${output_iconset_name}"
