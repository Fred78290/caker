...
unix_socket_path = os.path.join(os.path.expanduser("~"), ".cake", "cache", "unix_socket.sock")
console_socket_path = os.path.join(os.path.expanduser("~"), ".cake", "cache", "console.sock")
vm_name = "integration-test-devices"
curdir = os.path.abspath(os.path.dirname(__file__))
file_paths = [
	"{0}/guest/Dummy.txt".format(curdir)
]
